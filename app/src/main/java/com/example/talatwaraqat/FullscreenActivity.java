...
public class FullscreenActivity extends AppCompatActivity {
     ...
     * Counter for Win
     */
    private static int sequentialWinsCounter = 0;
  ...
  /*  private View mControlsView;
    ...
    public static void onImageCardFlip( int cardID,final ImageView imageView){
        ...
        int queenPosition = random.nextInt(3);
        /// counter
            if(queenPosition == cardID)sequentialWinsCounter++;
        /// local cache
            // get non-seq win counter and add 1
